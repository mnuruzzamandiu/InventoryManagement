...
<html lang="en" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact " dir="ltr"
    data-theme="theme-semi-dark" data-assets-path="{{ asset('contents/backend') }}/assets/"
...
<head>
    ...
    <!-- Core CSS -->
    <link rel="stylesheet" href="{{ asset('contents/backend') }}/assets/vendor/css/rtl/core.css"
        class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{ asset('contents/backend') }}/assets/vendor/css/rtl/theme-semi-dark.css"
...
<!-- Mirrored from demos.pixinvent.com/vuexy-html-admin-template/html/vertical-menu-template-semi-dark/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 25 Sep 2023 07:44:09 GMT -->
